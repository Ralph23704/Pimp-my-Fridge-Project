...
if (portId == null) {
System.out.println("Port COM inaccessible.");
return;
}
...
public synchronized String gettempint(){
	return chunks[1];
}
...
public void interpretation(String line){
	float temperatureint = 20;
	int temperatureconsigne = 15;
	
	if(temperatureint > temperatureconsigne)
	{
		try
		{
			output.write(1);
